				...
				>
					...
					<div className="relative z-10">
						...
						<div className="flex flex-col items-center gap-6 mb-8">
							<motion.a
								href="mailto:dassumit.ece@gmail.com"
							...
							<motion.a
								href="https://drive.google.com/file/d/12uyH2siPPYr3It18DRUlmDIgEkqWMVo_/view"
								target="_blank"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
						...
						<div className="flex flex-wrap justify-center gap-6">
							<motion.a
								href="https://github.com/sumitWebDev"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
							...
							<motion.a
								href="https://www.linkedin.com/in/sumit-kumar-das-16350090/"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
							...
							<motion.a
								href="https://x.com/eLEkTrO_sumit"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
